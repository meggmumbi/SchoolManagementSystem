...
namespace SchoolManagementUI.Controllers
{
    public class StudentTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,SessionID,ProgramID,ClassID,UserID,Name,FatherName,DateofBirth,Gender,ContactNo,CNIC,FNIC,Photo,AdmissionDate,PreviousSchool,PreviousPercentage,EmailAddress,Address,Nationality,Religion,TribeorCaste,FatherGuardiansOccupation,FatherGuardianPostalAddress,PhoneOffice,PhoneResident,IsEnrolled,ApplyDate,IsShortList,IsApply")] StudentTable studentTable)
        {
