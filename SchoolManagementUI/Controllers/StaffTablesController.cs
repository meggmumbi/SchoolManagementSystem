...
namespace SchoolManagementUI.Controllers
{
    public class StaffTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StaffID,UserID,Name,DesignationID,ContactNo,BasicSalary,EmailAddress,Address,Qualification,Photo,Description,IsActive,Gender,HomePhone,Doyouhaveanydisability,ifdisabilityyesthengiveusdetails,Areyoutakinganymedications,ifmedicationyesthengiveusdetails,AnyCriminaloffenceagainstyou,ifcriminaloffenceyesthengiveusdetails,RegistrationDate")] StaffTable staffTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StaffID,UserID,Name,DesignationID,ContactNo,BasicSalary,EmailAddress,Address,Qualification,Photo,Description,IsActive,Gender,HomePhone,Doyouhaveanydisability,ifdisabilityyesthengiveusdetails,Areyoutakinganymedications,ifmedicationyesthengiveusdetails,AnyCriminaloffenceagainstyou,ifcriminaloffenceyesthengiveusdetails,RegistrationDate")] StaffTable staffTable)
        {
            if (ModelState.IsValid)
            {
