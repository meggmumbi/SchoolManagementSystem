...
namespace SchoolManagementUI.Controllers
{
    public class StaffAttendanceTablesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StaffAttendanceID,StaffID,AttendDate,AttendTime,ComingTime,ClosingTime")] StaffAttendanceTable staffAttendanceTable)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StaffAttendanceID,StaffID,AttendDate,AttendTime,ComingTime,ClosingTime")] StaffAttendanceTable staffAttendanceTable)
        {
            if (ModelState.IsValid)
            {
